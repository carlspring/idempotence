...
class GradleParallelTest3
{
    ...
    void testSingleFile()
    {
        File testResource = new File("build/test-resources/GradleParallelTest3/testSingleFile/foo.txt");
    ...
    {
        File testResource = new File("build/test-resources/GradleParallelTest3/testWithPatterns/nested/dir/foo.txt");
