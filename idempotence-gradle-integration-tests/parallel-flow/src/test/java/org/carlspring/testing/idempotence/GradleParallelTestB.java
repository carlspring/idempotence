...
/**
 * Second of three concurrently-initialised test classes that verify {@link TestResourceExtension}
...
class GradleParallelTestB
{
    ...
    void testSingleFile()
    {
        File testResource = new File("build/test-resources/GradleParallelTestB/testSingleFile/foo.txt");
    ...
    {
        File testResource = new File("build/test-resources/GradleParallelTestB/testWithPatterns/nested/dir/foo.txt");
