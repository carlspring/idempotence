...
class GradleParallelTest2
{
    ...
    void testSingleFile()
    {
        File testResource = new File("build/test-resources/GradleParallelTest2/testSingleFile/foo.txt");
    ...
    {
        File testResource = new File("build/test-resources/GradleParallelTest2/testWithPatterns/nested/dir/foo.txt");
