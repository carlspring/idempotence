...
class GradleParallelTest8
{
    ...
    void testSingleFile()
    {
        File testResource = new File("build/test-resources/GradleParallelTest8/testSingleFile/foo.txt");
    ...
    {
        File testResource = new File("build/test-resources/GradleParallelTest8/testWithPatterns/nested/dir/foo.txt");
