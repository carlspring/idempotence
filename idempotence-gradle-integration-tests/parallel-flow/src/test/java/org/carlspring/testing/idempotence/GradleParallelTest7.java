...
class GradleParallelTest7
{
    ...
    void testSingleFile()
    {
        File testResource = new File("build/test-resources/GradleParallelTest7/testSingleFile/foo.txt");
    ...
    {
        File testResource = new File("build/test-resources/GradleParallelTest7/testWithPatterns/nested/dir/foo.txt");
